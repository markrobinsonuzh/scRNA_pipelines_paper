...
\begin{figure}
    \centering
    \ifshowfigs
    \includegraphics[width=\textwidth, keepaspectratio]{{main_figures/dr.pdf}}
    \fi
...
\begin{figure}
    \centering
    \ifshowfigs
    \includegraphics[width=\textwidth, keepaspectratio]{{main_figures/imputation.pdf}}
    \fi
