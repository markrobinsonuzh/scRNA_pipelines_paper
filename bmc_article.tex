...
\subsubsection*{Excluding more cells is not necessarily good}
...
To estimate the correlation between the first principal components and covariates such as library size, we first fitted a linear model on the subpopulations, and correlated the residuals of this model with the covariate of interest.
