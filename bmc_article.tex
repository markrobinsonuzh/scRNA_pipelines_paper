...
\begin{enumerate}
   ...
   \begin{itemize}
     ...
     \item Distribution-based cell filtering fails to capture doublets and should use relatively lenient cutoffs (e.g., 5 MADs, or 3 MADs in at least 2 distributions - see for instance our 'default' filters in the methods) to exclude poor-quality cells while avoiding bias against some subpopulations.
