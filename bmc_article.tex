...
\begin{figure}
    \centering
    \includegraphics[scale=0.7, keepaspectratio]{main_figures/pipeline_explanation.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.65, keepaspectratio]{{main_figures/doublets.pdf}}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.60, keepaspectratio]{{main_figures/filtering.pdf}}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.40, keepaspectratio]{{main_figures/dr.pdf}}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.53, keepaspectratio]{{main_figures/dimensionality.pdf}}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.34, keepaspectratio]{{main_figures/clustering.pdf}}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.49, keepaspectratio]{{main_figures/imputation.pdf}}
