...
(NOTE: a correlation of PC1 with library size might be caused by the fact that subpopulations have a different average library size. I'm repeating this evaluation with the variance explained by libSize in a PC1\textasciitilde subpopulation+libSize model.)
