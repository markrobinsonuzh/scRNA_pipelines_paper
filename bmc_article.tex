...
We next investigated the step of dimensionality reduction, comparing in particular Seurat's PCA, GLM-PCA \citep{townesGlmpca2019}, and a two-step PCA. Seurat's default PCA weighs the cell embeddings by the variance of each component,+
